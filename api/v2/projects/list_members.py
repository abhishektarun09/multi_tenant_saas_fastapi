...
async def list_members(
    ...
    if cached_users_in_project:
        ...
        users_in_project = ListMembers(organization_id=membership.organization_id, project_id=project_id, member_details=member_details)
        
        print("database")
        
        await redis.set(cache_key, orjson.dumps(users_in_project.model_dump()), ex=60 * 5)
